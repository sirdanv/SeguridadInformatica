...
namespace SeguridadInformatica.Controllers
{
    public class ActivosController : Controller
    {
        ...
        {
              return _context.Activos != null ? 
                          View(await _context.Activos.ToListAsync()) :
                          Problem("Entity set 'SeguridadInformaticaContext.Activos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ActivosId,Nombre,Descripcion,Valor")] Activos activos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ActivosId,Nombre,Descripcion,Valor")] Activos activos)
        {
